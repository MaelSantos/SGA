...
public enum TipoAudiencia {
	...
	JUSTIFICACAO("JUSTIFICAÇÃO"), EXECUCAO("EXECUÇÃO"), INICIAL("INICIAL") ,INSTRUCAO("INSTRUÇÃO"),
	INSTRUCAO_JULGAMENTO("INSTRUÇÃO JULGAMENTO"), JULGAMENTO("JULGAMENTO"), PRELIMINAR("PRELIMINAR"),
