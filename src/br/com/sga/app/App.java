...
public class App extends Application{
	...
	consulta,detalhesConsulta,detalhesContrato,documentos, historico,estatistica, cadastroParte, detalhesNotificacao;
	...
	public static Pane changePane(Tela tela)
	{
		...
		case DETALHES_NOTIFICACAO:
			return detalhesNotificacao;
		default:
			break;
		}
		return new Pane();
